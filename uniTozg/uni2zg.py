...
def replace(input):
    ...
    output = re.sub(u'\u103a', u'\u1039', output)  # nga_that
    output = re.sub(u'\u103b', u'\u103a', output)  # ya_pint
    output = re.sub(u'\u103c', u'\u103b', output)  # ya_yit
    output = re.sub(u'\u103d', u'\u103c', output)  # wa_swal
    output = re.sub(u'\u103e', u'\u103d', output)  # ha_htoe
    output = re.sub(u'\u103f', u'\u1086', output)  # tha_gyi
...
def precompose(input):
    ...
    output = re.sub(u'\u100d\u1039\u100d', u'\u106e', output)  # da_yin_gout
    output = re.sub(u'\u100d\u1039\u100e', u'\u106f', output)  # da_yin_mote
...
def shape(input):
    ...
    # ta/na_chuang_ngin
    output = re.sub(u'([\u1008\u100b\u100c\u100d\u1020])\u102f', u'\\1\u1033', output)  # 1cn with letters
    output = re.sub(u'([\u1008\u100b\u100c\u100d\u1020])\u1030', u'\\1\u1034', output)  # 2cn with letters
    ...
    output = re.sub(u'\u1014([\u1065-\u1069])', u'\u108f\\1', output)  # 2cn with prsint before from salone_zamyinswal
